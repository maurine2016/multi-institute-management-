    ...
    <div class="row">
        <div class="col">
            ...
            <h2 class="text-center font-weight-normal">
                <span class="border-bottom"><i class="fa fa-clipboard"></i> <?php esc_html_e( 'Certificate', WL_MIM_DOMAIN ); ?></span>
            </h2>
			<?php
            ...
            <div class="card-header bg-primary text-white">
                ...
                <div class="row">
                    <div class="col-md-9 col-xs-12">
                        <div class="h4"><?php esc_html_e( 'Manage Certificates', WL_MIM_DOMAIN ); ?></div>
                    </div>
                    <div class="col-md-3 col-xs-12">
                        <button type="button" class="btn btn-outline-light float-right add-notice" data-toggle="modal" data-target="#add-notice" data-backdrop="static" data-keyboard="false">
                            <i class="fa fa-plus"></i> <?php esc_html_e( 'Add New Certificate', WL_MIM_DOMAIN ); ?>
                        </button>
                    </div>
                </div>
                        ...
                        <table class="table table-hover table-striped table-bordered" id="notice-table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"><?php esc_html_e( 'Total Numer of Certificate', WL_MIM_DOMAIN ); ?></th>
                                    <th scope="col"><?php esc_html_e( 'Distribute', WL_MIM_DOMAIN ); ?></th>
