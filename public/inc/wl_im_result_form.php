            ...
            <form id="wlim-exam-result-form">
				<?php if ( ! $institute ) { ?>
                    <div class="form-group">
                        ...
                        <select name="institute" class="form-control" id="wlim-result-institute">
				...
				<?php } ?>
                <div class="form-group">
                    <label for="wlim-result-enrollment_id" class="col-form-label">
						*<strong><?php esc_html_e( 'Enrollment ID', WL_MIM_DOMAIN ); ?>:</strong>
					</label>
                    <input name="enrollment_id" type="text" class="form-control" id="wlim-result-enrollment_id" placeholder="<?php esc_html_e( "Enrollment ID", WL_MIM_DOMAIN ); ?>">
                </div>
                <div class="mt-3 float-right">
                    <button type="submit" class="btn btn-primary view-exam-result-submit"><?php esc_html_e( 'Get Result!', WL_MIM_DOMAIN ); ?></button>
                </div>
            </form>
        </div>
    </div>
